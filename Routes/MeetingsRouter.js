...
// Get all meetings
MeetingsRouter.get('/',  middleware.isAdmin, async (req, res, next) => {
  try {
     Meetings.find()
...
MeetingsRouter.post('/',  middleware.isAdmin, async (req, res, next) => {
...
MeetingsRouter.patch('/:id',  middleware.isAdmin, async (req, res) => {
  let meeting;
  try {
...
MeetingsRouter.delete('/:id',  middleware.isAdmin, async (req, res, next) => {
...
MeetingsRouter.post("/sendEmail", middleware.isAdmin, async (req, res, next) => {
